...
var world_map = new jsVectorMap({
	...
	// regionStyle: {
	// 	initial: {
	// 		fill: '#e4e4e4', // Set a neutral color for all regions
	// 	},
	// 	selected: {
	// 		fill: '#435ebe' // Highlight Morocco
	// 	},
	// 	hover: {
	// 		fill: '#435ebe' // Highlight Morocco on hover
	// 	}
	// },
	// selectedRegions: ['MA'], // Highlight Morocco only (ISO code: MA)
	// markers: [
	// 	{
	// 		name: 'Casablanca',
	// 		coords: [33.5731, -7.5898], // Coordinates for Casablanca
	// 		style: {
	// 			fill: '#435ebe'
	// 		}
	// 	},
	// 	{
	// 		name: 'Rabat',
	// 		coords: [34.020882, -6.84165], // Coordinates for Rabat
	// 		style: {
	// 			fill: '#28ab55'
	// 		}
	// 	},
	// 	{
	// 		name: 'Marrakech',
	// 		coords: [31.6295, -7.9811], // Coordinates for Marrakech
	// 		style: {
	// 			fill: '#f3616d'
	// 		}
	// 	},
	// 	{
	// 		name: 'Tangier',
	// 		coords: [35.7595, -5.8340], // Coordinates for Tangier
	// 		style: {
	// 			fill: '#ffc107'
	// 		}
	// 	},
	// 	{
	// 		name: 'Agadir',
	// 		coords: [30.4278, -9.5981] // Coordinates for Agadir
	// 	}
	// ],
	// onRegionTooltipShow(event, tooltip, code) {
	// 	// Show tooltip only for Morocco
	// 	if (code !== 'MA') {
	// 		event.preventDefault(); // Hide tooltip for other countries
	// 	} else {
		...
		scales: {
			yAxes: [{
				ticks: {
					...
					max: 100, // Set maximum value to accommodate more ticks (adjust this value based on your data)
					padding: 10
				},
				gridLines: {
					drawTicks: false,
...
// var morocco_map = new jsVectorMap({
// 	selector: "#morocco-map",
// 	map: "morocco_mill", // Use the Morocco map
// 	zoomOnScroll: false,
// 	regionStyle: {
// 		hover: {
// 			fill: '#435ebe'
...
// 		{
// 			name: 'Casablanca',
// 			coords: [33.5731, -7.5898], // Latitude, Longitude for Casablanca
// 			style: {
// 				fill: '#435ebe'
// 			}
// 		},
// 		{
// 			name: 'Marrakech',
// 			coords: [31.6295, -7.9811], // Latitude, Longitude for Marrakech
// 			style: {
// 				fill: '#28ab55'
// 			}
// 		},
// 		{
// 			name: 'Rabat',
// 			coords: [34.0209, -6.8417], // Latitude, Longitude for Rabat
// 			style: {
// 				fill: '#f3616d'
// 			}
// 		},
// 		{
// 			name: 'Fes',
// 			coords: [34.0334, -5.0034] // Latitude, Longitude for Fes
// 		},
// 		{
// 			name: 'Tanger',
// 			coords: [35.7673, -5.8024] // Latitude, Longitude for Tangier
// 		},
// 		{
// 			name: 'Agadir',
// 			coords: [30.4278, -9.5982] // Latitude, Longitude for Agadir
// 		},
// 		// Add more companies and their locations here
// 	],
// 	onRegionTooltipShow(event, tooltip) {
// 		tooltip.css({ backgroundColor: '#435ebe' });
// 	}
